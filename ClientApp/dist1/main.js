...
let UserSecurityComponent = class UserSecurityComponent {
    ...
    //}
    Audittracking() {
        return this.http.get("http://24.187.220.60/SmartFormulator_WebService2/AuditTracking");
    }
    GetGroupNameDes() {
    ...
    GetUserList(check) {
        ...
        return this.http.get("http://24.187.220.60/SmartFormulator_Webservice2/usersettingsdata", { params: params1 });
    }
    setradio(e) {
