...
@Component({
  selector: 'app-new-microb',
  templateUrl: './new-microb.component.html',
  styleUrls: ['./new-microb.component.css']
})
export class NewMicrobComponent implements OnInit {
  ...
  openaddmicrobiology(): void {
    const dialogRef = this.dialog.open(AddmicroComponent, {
