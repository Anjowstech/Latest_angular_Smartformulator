...
@Component({
  selector: 'app-search-tradename',
  templateUrl: './search-tradename.component.html',
  styleUrls: ['./search-tradename.component.css']
})
export class SearchTradenameComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private http: HttpClient, public dialogRef: MatDialogRef<SearchTradenameComponent>,) { }
