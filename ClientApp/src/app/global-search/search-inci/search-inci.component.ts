...
@Component({
  selector: 'app-search-inci',
  templateUrl: './search-inci.component.html',
  styleUrls: ['./search-inci.component.css']
})
export class SearchInciComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog, private http: HttpClient, public dialogRef: MatDialogRef<SearchInciComponent>,) { }
