...
export class SampleManagementComponent implements OnInit {
  ...
  SaveSampleClick(formulacode: string, PDRno: string, cstmrname: string, submissionno: string, username: string, formulaname: string, UnApproved: string, PDRStatus: string ) {
    ...
    var UnApprovedrow: string = UnApproved;
    var pdrstatus1: string = this.PDRStatus;
    let params1 = new HttpParams().set('FormulaCode', FormulaCode1).set('PDR', PDRr).set('Customername', Customername1).set('submissionno', samplesubmissionno1).set('username', username1)
  ...
  SaveSample() {
    ...
    this.SaveSampleClick(this.formulacode, this.PDRno, this.cstmrname, this.submissionno, this.username, this.formulaname, this.UnApproved, this.PDRStatus
  ...
  btnval = "save";
  ChangeText() {
    if (this.PDRStatus == "Approved" || "AW-Approved-ON WAIVER")
      {
      this.btnval = "Update";
