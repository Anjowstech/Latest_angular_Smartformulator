...
@Component({
  selector: 'app-tradename-select',
  templateUrl: './tradename-select.component.html',
  styleUrls: ['./tradename-select.component.css']
})
export class TradenameSelectComponent implements OnInit {
  ...
  getlabels: string;
  constructor(@Inject(MAT_DIALOG_DATA) public data: any,private http: HttpClient, private Datashare: DataShareServiceService, public dialogRef: MatDialogRef<TradenameSelectComponent>) { }
  Loadsearchraw() {
